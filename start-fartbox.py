...
print("5) 1280x800 (16:9)")
print("6) Custom resolution")
print("7) Back to previous menu")
print("")
res = input()
if res != "1" and res != "2" and res != "3" and res != "4" and res != "5" and res != "6" and res != "7" and res != "8":
    ...
    if res == "":
        ...
        exit()
    os.system("clear")
    print("\033[0;33mTermux-X11 and Wine started. If you want exit from BoxFartBox, type \033[0;36m'1'\033[0;33m (or any key) or \033[0;36m'2'\033[0;33m to back to main menu in the terminal then press enter.\033[0m")
    os.system("taskset -c 0-7 box64 wine explorer /desktop=shell," + res + " $PREFIX/glibc/opt/autostart.bat &>/dev/null &")
elif res == "7":
